...
w->Draw("pt:eta>>h_pt_vs_eta",ept && ecc && eccfid && wmt && wmet && wut && emid && etrkspat && etrkgood);
w->Draw("e:eta>>h_e__vs_eta",ept && ecc && eccfid && wmt && wmet && wut && emid && etrkspat && etrkgood);
...
h___________________________________->SetMinimum(0.5);
