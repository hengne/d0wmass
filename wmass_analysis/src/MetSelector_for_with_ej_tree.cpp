#include "wmass_analysis/MetSelector_for_with_ej_tree.hpp"
...
MetSelector_for_with_ej_tree::MetSelector_for_with_ej_tree(const char *name):Processor(name) {
  Config config(name);
...
MetSelector_for_with_ej_tree::~MetSelector_for_with_ej_tree() {
}

//
// extract missingET
//
void MetSelector_for_with_ej_tree::extract(cafe::Event& event, vector<CAFEMObj*> emobjs) {  
...
//
void MetSelector_for_with_ej_tree::applyCorrection(cafe::Event& event, vector<CAFEMObj*> emobjs, float vtx_old[3], float vtx_new[3]) {
...
//
void MetSelector_for_with_ej_tree::putPointers(cafe::Event& event) {
...
//
void MetSelector_for_with_ej_tree::make_EMCorr(cafe::Event& event, vector<CAFEMObj*> emobjs, float metX_raw, float metY_raw, float met_raw, float scalarEt_raw,
...
ClassImp(MetSelector_for_with_ej_tree)
