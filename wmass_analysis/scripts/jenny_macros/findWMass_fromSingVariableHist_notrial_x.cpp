...
int main( int argc, char *argv[] )
{
  ...
  if( argc < 5) {
    std::cout<< "Usage : ./findWMass_fromhist_x <input-filenames> <output-filename> <template-filename> <compare-option> <sv> <input sv trial mass>" << std::endl;
...
double tot_err = 0;
  ...
  if ( (mtpt=="SVgen" || mtpt=="Svgen" || mtpt=="svgen" ) && (compare_option==2) ){
    ...
    dirname = "default";
    genhistname = "hWcandSingVariable_Gen_CC";
    ...
    histname = "hWcandSingVariable_CC";
  ...
  if (compare_option == 2) {
    ...
    histname = "WCand_SingVariable_CC";
    tempname = "WCand_SingVariable_CC_";
    genhistname = "WCand_SingVariable_Gen_CC";
  ...
  **/
  ...
  cout << "Booked histograms" << endl;
    ...
    //cout<<templatemin<<"  "<<templatemax<<"  "<<templatemid<<"  "<<trialmass<<endl;
    template_map->GetXaxis()->Set(templatebins,
    				  templatemin + (templatemid - trialmass),
    				  templatemax + (templatemid - trialmass));
     //cout<<templatemin + (templatemid - trialmass)<<"  "<<templatemax + (templatemid - trialmass)<<endl;
     //cout<<template_map->GetXaxis()->GetXmin()<<"  "<<template_map->GetXaxis()->GetXmax()<<endl;
    template_map->Write();
