...
//          passes the top e+jets level2 trigger condition
//----------------------------------------------------------

//Header file for this class
#include "caf_trigger/Probability_TopEJets_L2.hpp"

using namespace std;

Probability_TopEJets_L2::Probability_TopEJets_L2(const char *name)
  : probProcessor(name)
{
...
void Probability_TopEJets_L2::defineEffInfo(std::map< std::string, eff_utils::EffInfo >& _effInfo)
{
...
//--------------------------------------
double Probability_TopEJets_L2::calcProb(std::string version)
{
  //------------------------------------
  // This sets up the channel name and is important to set!
  // This is the value specified to combine in the config file
  //------------------------------------
  _channel = "TopEJets_L2";
    
  double probability = Prob_TopEJets_L2(version);
...
//------------------------------------------------------------------------------
double Probability_TopEJets_L2::Prob_TopEJets_L2(std::string version)
{

  double probability = ( Prob_TopEJets_Electron_L2(version) *
			 Prob_TopEJets_Jet_L2(version) );

  if ( _debug ) {
    cout << "EJets L2 probability = " << probability << endl;
  }
...
//------------------------------------------------------------------------------
double Probability_TopEJets_L2::Prob_TopEJets_Electron_L2(std::string version){
...
//------------------------------------------------------------------------------
double Probability_TopEJets_L2::Prob_TopEJets_Jet_L2(std::string version){
...
ClassImp(Probability_TopEJets_L2)
