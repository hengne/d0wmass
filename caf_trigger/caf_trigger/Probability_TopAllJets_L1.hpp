...
// Last Updated: 2/9/06
//
// Purpose:  Header file for the plugin processor Probability_TopAllJets_L1
...
//Inherits from probProcessor
class Probability_TopAllJets_L1 : public probProcessor
{
 public:
  Probability_TopAllJets_L1(const char *name);
  ...
  double Prob_TopAllJets_L1(std::string version);
  double Prob_TopAllJets_Jet_L1(std::string version);


  ////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////

  ClassDef(Probability_TopAllJets_L1, 0);
 private:
