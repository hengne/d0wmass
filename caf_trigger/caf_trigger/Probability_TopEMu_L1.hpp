...
// Last Updated: 2/9/06
//
// Purpose:  Header file for the plugin processor Probability_TopEMu_L1
...
//Inherits from probProcessor
class Probability_TopEMu_L1 : public probProcessor
{
 public:
  Probability_TopEMu_L1(const char *name);
  ...
  double Prob_TopEMu_L1(std::string version);
  double Prob_TopEMu_Electron_L1(std::string version);
  double Prob_TopEMu_Muon_L1(std::string version);
  double Prob_TopEMu_Track_L1(std::string version);


  ////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////

  ClassDef(Probability_TopEMu_L1, 0);
 private:
