...
class Probability_EJets : public probProcessor
{
 public:
  Probability_EJets(const char *name);
...
//   std::vector<float> _trigger_lumi;
  ...
  std::vector<double> _x8, _s8, _x9, _s9, _x10, _s10, _x11, _s11,_x12,_s12;
