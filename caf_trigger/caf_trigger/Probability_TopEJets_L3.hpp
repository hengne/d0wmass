...
// Last Updated: 2/9/06
//
// Purpose:  Header file for the plugin processor Probability_TopEJets_L3
...
//Inherits from probProcessor
class Probability_TopEJets_L3 : public probProcessor
{
 public:
  Probability_TopEJets_L3(const char *name);
  ...
  double Prob_TopEJets_L3(std::string version);
  double Prob_TopEJets_Jet_L3(std::string version);
  double Prob_TopEJets_Electron_L3(std::string version);


  ////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////

  ClassDef(Probability_TopEJets_L3, 0);
 private:
