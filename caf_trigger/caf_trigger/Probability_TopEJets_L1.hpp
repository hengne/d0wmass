...
// Last Updated: 2/9/06
//
// Purpose:  Header file for the plugin processor Probability_TopEJets_L1
...
//Inherits from probProcessor
class Probability_TopEJets_L1 : public probProcessor
{
 public:
  Probability_TopEJets_L1(const char *name);
  ...
  double Prob_TopEJets_L1(std::string version);
  double Prob_TopEJets_Jet_L1(std::string version);
  double Prob_TopEJets_Electron_L1(std::string version);


  ////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////

  ClassDef(Probability_TopEJets_L1, 0);
 private:
