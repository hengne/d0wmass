...
// Last Updated: 2/9/06
//
// Purpose:  Header file for the plugin processor Probability_TopAllJets_L2
...
//Inherits from probProcessor
class Probability_TopAllJets_L2 : public probProcessor
{
 public:
  Probability_TopAllJets_L2(const char *name);
  ...
  double Prob_TopAllJets_L2(std::string version);
  double Prob_TopAllJets_Jet_L2(std::string version);
  double Prob_TopAllJets_Jet_HT(std::string version);


  ////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////

  ClassDef(Probability_TopAllJets_L2, 0);
 private:
