...
ln -sf $SRCDIR/run2b_data.root .
ln -sf $SRCDIR/run2a_data.root .
ln -sf $SRCDIR/run2b_mc.root .
ln -sf $SRCDIR/run2a_mc.root .
ln -sf $SRCDIR/run2a_trigbits.root .
ln -sf `ctpkgpath tmb_tree $TOPDIR`/data/triggers2a.txt .
